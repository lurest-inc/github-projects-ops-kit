...
# 工数集計レポート生成スクリプト
# https://lurest-inc.github.io/github-projects-ops-kit/scripts/generate-effort-report
#
# 環境変数:
...
OUTPUT_FILE=$(build_output_filename "report" "effort")
...
append_to_workflow_summary "${OUTPUT_FILE}" format_effort_markdown

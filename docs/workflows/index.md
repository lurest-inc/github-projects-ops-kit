...
| [④ Issue Label 一括作成](04-setup-repository-labels.md) | 設定ファイルで定義した Issue Label を Repository に一括作成 |
| [⑤ 初期ファイル一括作成](05-setup-repository-files.md) | Community Health Files・Scaffold ファイルを Repository に一括登録 |

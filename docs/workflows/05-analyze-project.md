...
> **Note:** この機能はWorkflow④（Project アイテム エクスポート）から統合されたものです。
...
> **Warning:** レポートには担当者名・工数・ステータスなどプロジェクト管理上の情報が含まれます。Public Repositoryで運用する場合は、これらの情報が第三者に公開されるリスクを十分にご理解ください。

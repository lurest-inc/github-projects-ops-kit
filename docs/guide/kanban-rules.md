...
<li><a href="#-%E3%82%AB%E3%82%B9%E3%82%BF%E3%83%A0%E3%83%95%E3%82%A3%E3%83%BC%E3%83%AB%E3%83%89">🏷️ カスタムField</a></li>
...
本キットでは、以下の 5 つのStatusカラムを使用したカンバンフローを採用しています。
...
本キットでは、以下のカスタムFieldを Project に追加します。
...
| View 名 | 種類 | 用途 |
|---------|------|------|
| **Table** | テーブル | 全Itemの一覧表示。Fieldの確認・編集に適している |
| **Board** | ボード | カンバン形式でStatusごとにItemを表示。進捗管理に適している |

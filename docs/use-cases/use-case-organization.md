...
**GitHub Projects Ops Kit** を使えば、統一されたプロジェクト運用をすぐに立ち上げられます。
...
[このリポジトリを Fork](https://github.com/lurest-inc/github-projects-ops-kit/fork) して、自分の Organization または個人アカウントにコピーします。
